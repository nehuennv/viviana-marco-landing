...
// Mantenemos framer-motion SOLO para el feedback visual de los puntitos y la escala en móvil (interacción, no scroll)
...
const Reviews = () => {
  ...
  // OPTIMIZACIÓN: Usamos el mismo sistema robusto de Services.jsx
  ...
  // --- OBSERVER EFICIENTE (Reemplaza al scroll listener manual) ---
  useEffect(() => {
  ...
  return (
    <section id='reviews' className="py-12 md:py-24 relative overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto px-0 md:px-6 relative z-10">
        ...
        {/* --- GRID / CAROUSEL --- */}
        <div
          // Usamos el callback ref para capturar el contenedor
        ...
        {/* Entrada con AOS */}
        <div
          className="flex flex-col md:flex-row justify-center gap-3 md:gap-6 px-6 md:px-0 md:mt-12"
          data-aos="fade-up"
          data-aos-delay="300"
        >
