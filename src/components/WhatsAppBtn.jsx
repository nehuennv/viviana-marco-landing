...
const WhatsAppBtn = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-2 pointer-events-none">
      ...
      {/* Estilos para la animación de onda (CSS Puro) */}
      <style>{`
            ...
            <AnimatePresence>
              {isHovered && (
                <motion.div
                  ...
                  // CAMBIOS AQUÍ: bg-white sólido, sin border.
                ...
                >
                  ...
                  {/* El triangulito ahora es del mismo color sólido y sin borde, para fusionarse */}
